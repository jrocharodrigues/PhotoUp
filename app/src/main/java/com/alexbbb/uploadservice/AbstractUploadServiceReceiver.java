...
public abstract class AbstractUploadServiceReceiver extends BroadcastReceiver {
            ...
            if (UploadService.getActionBroadcast().equals(intent.getAction())) {
                ...
                switch (status) {
                    ...
                    case UploadService.STATUS_IN_PROGRESS:
                        ...
                        final int currentItem = intent.getIntExtra(UploadService.CURRENT_ITEM, 0);
                        onProgress(uploadId, progress, currentItem);
                        break;
     ...
     * @param currentItem item # being upload, from 1 to number of items
     */
    public abstract void onProgress(final String uploadId, final int progress, final int currentItem);
